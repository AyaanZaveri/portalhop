<img src="public/portalhop-logo.png" width="56" alt="PortalHop logo" />
...
One player for every IPTV source you've got. Add Stalker (MAG), Xtream Codes, or M3U portals — or skip setup entirely with the built-in free channel catalog — and watch everything from one clean UI, with a synced programme guide and favorites, on any device.

**[Try it → portalhop.vercel.app](https://portalhop.vercel.app/)**
...
- **Bring your own portals** — Stalker/MAG (portal URL + MAC), Xtream Codes (server + credentials), or a plain M3U playlist URL. There's also a built in IPTV-org catalog has thousands of free channels with no account required.
